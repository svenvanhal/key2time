...
namespace Timetabling.Algorithms.FET
{
    ...
    public class FetOutputProcessor
    {
        ...
        /// <summary>
        /// Remove all output files generated by FET.
        /// </summary>
        /// <exception cref="DirectoryNotFoundException">Throws DirectoryNotFoundException when the base directory is not correctly configured or if FET has failed to run correctly.</exception>
